...
if __name__ == '__main__':
    ...
    if args.train == "single_train":
        ...
        print(param_grid)
        model = grid_train_model(X_train, Y_train, imbalance=str_to_bool(args.imbalance), random_state=random_state, cores=int(args.cores), param_grid=param_grid)
    ...
    if not Save_location.endswith("Model/"):
        Save_location += "Model/"
